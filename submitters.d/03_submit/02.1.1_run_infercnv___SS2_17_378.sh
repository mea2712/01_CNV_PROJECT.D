...
#SBATCH -n 8
#SBATCH -t 03:00:00
#SBATCH -J 02.1.1_run_infercnv___SS2_17_378
#SBATCH --output 02.1.1_run_infercnv_SS2_17_378_%J.stdout
...
logdir="/castor/project/proj/maria.d/01_CNV_PROJECT.D/code.d/routs.d/03_routs/"
lognm="02.1.1_run_infercnv"
outnm="SS2_17_378"

indir='/castor/project/proj/maria.d/01_CNV_PROJECT.D/output.d/03_out/01.2.1_input_infercnv'
outdir='/castor/project/proj/maria.d/01_CNV_PROJECT.D/output.d/03_out/'
