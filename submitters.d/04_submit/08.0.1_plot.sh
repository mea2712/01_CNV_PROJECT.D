...
# LOCAL VARIABLES
# input files
args0="/castor/project/proj/maria.d/01_CNV_PROJECT.D/output.d/04_temp/03.1.1_collect_results_infercnv__"
args00=$( ls ${args0}* )
...
# pagoda files
args5="as.character('/castor/project/proj/maria.d/01_CNV_PROJECT.D/data.d/04_data/NB_KEql10.rds')"

# Input file to inferCNV
args6="as.character('/castor/project/proj/maria.d/01_CNV_PROJECT.D/output.d/04_out/01.2.1_input_infercnv___CELLS-')"

# Input file with bulk seq reference CNV
args13="as.character('/castor/project/proj/maria.d/01_CNV_PROJECT.D/data.d/04_data/bulk_seq_CNV.txt')"

# Input file with chromosome regions
args15="as.character('/castor/project/proj/maria.d/01_CNV_PROJECT.D/data.d/04_data/ChrRegions_pq')"
...
# Output directory
args8="as.character('/castor/project/proj/maria.d/01_CNV_PROJECT.D/output.d/04_plots/')"
args10="as.character('/castor/project/proj/maria.d/01_CNV_PROJECT.D/output.d/04_temp/')"
args14="as.character('/castor/project/proj/maria.d/01_CNV_PROJECT.D/output.d/04_out/')"
