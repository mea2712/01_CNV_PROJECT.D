...
# Input files
# NB pagoda rds file
args1="as.character('/castor/project/proj/maria.d/01_CNV_PROJECT.D/data.d/04_data/NB_KEql10.rds')"
...
# NB counts file
args4="as.character('/castor/project/proj/maria.d/01_CNV_PROJECT.D/data.d/04_data/hg38.noIntrns.NBhighQC.allGns.counts.htsq.clltyHQ.noMitchnd.csv')"

# Genes file
args5="as.character('/castor/project/proj/maria.d/01_CNV_PROJECT.D/data.d/04_data/hg38.genecodeV28Comp.ERCCeGFP.cfflinks.noIntrns.gnNms.biotyp.gtf')"

# Ouput directories
args6="as.character('/castor/project/proj/maria.d/01_CNV_PROJECT.D/output.d/04_out/')"
args7="as.character('/castor/project/proj/maria.d/01_CNV_PROJECT.D/output.d/04_temp/')"
