...
indir="/castor/project/proj/maria.d/01_CNV_PROJECT.D/output.d/04_out/02.1.1_run_infercnv"
# version and paramters used and included in results file names
par="v1.4.0_0.1_1_101"
# pagoda run results
indir1="/castor/project/proj/maria.d/01_CNV_PROJECT.D/data.d/04_data/NB_KEql10.rds"
# output directory
outdir="/castor/project/proj/maria.d/01_CNV_PROJECT.D/output.d/04_temp/"
# output files name
...
patt="01_CNV_PROJECT.D/output.d/04_out/01.2.1_input_infercnv___COUNTS-"
