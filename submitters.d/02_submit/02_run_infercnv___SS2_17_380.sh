...
#SBATCH -n 8
#SBATCH -t 03:00:00
#SBATCH -J 02_run_infercnv___SS2_17_380
...
outnm="SS2_17_380"
args1="as.character('/castor/project/proj/maria.d/01_CNV_PROJECT.D/output.d/02_out/01.2_input_infercnv___COUNTS-SS2_17_380')"
args2="as.character('/castor/project/proj/maria.d/01_CNV_PROJECT.D/output.d/02_out/01.2_input_infercnv___CELLS-SS2_17_380')"
args3="as.character('/castor/project/proj/maria.d/01_CNV_PROJECT.D/output.d/01_out/01_input_infercnv___GENES')"
grep 'normal' /castor/project/proj/maria.d/01_CNV_PROJECT.D/output.d/02_out/01.2_input_infercnv___CELLS-SS2_17_380 | awk '{print $2}' | sort | uniq > temp
args4="as.character('XXX')"
args5="as.character('/castor/project/proj/maria.d/01_CNV_PROJECT.D/output.d/02_out/')"
args6="as.character('SS2_17_380')"
