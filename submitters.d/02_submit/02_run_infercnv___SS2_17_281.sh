...
outnm="SS2_17_281"
args1="as.character('/castor/project/proj/maria.d/01_CNV_PROJECT.D/output.d/02_out/01.2_input_infercnv___COUNTS-SS2_17_281')"
args2="as.character('/castor/project/proj/maria.d/01_CNV_PROJECT.D/output.d/02_out/01.2_input_infercnv___CELLS-SS2_17_281')"
args3="as.character('/castor/project/proj/maria.d/01_CNV_PROJECT.D/output.d/01_out/01_input_infercnv___GENES')"
grep 'normal' /castor/project/proj/maria.d/01_CNV_PROJECT.D/output.d/02_out/01.2_input_infercnv___CELLS-SS2_17_281 | awk '{print $2}' | sort | uniq > temp
