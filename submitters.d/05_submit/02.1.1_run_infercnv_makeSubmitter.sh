...
indir='/castor/project/proj/maria.d/01_CNV_PROJECT.D/output.d/05_out/01.2.1_input_infercnv'
# output dir path 
outdir='/castor/project/proj/maria.d/01_CNV_PROJECT.D/output.d/05_out/'
...
submlogdir="${codedir}submitters.d/05_submit/"
# file where arguments to be pass are
argss='/castor/project/proj/maria.d/01_CNV_PROJECT.D/code.d/submitters.d/05_submit/02.1_run_infercnv_makeArgs.sh'
#-----------------------------------------------------------------------#

# SUBMITTER GENERATOR
# Pattern of COUNT files (or CELLS files) produced by 01.2_input.infercnv.R -everything but the SAMPLE ID -
args1="01_CNV_PROJECT.D/output.d/05_out/01.2.1_input_infercnv___COUNTS-"
